...
export const records = [
  ...
  .concat(
    [
      ...
      "mieszkania/sprzedaz/warszawa/?search%5Bdistrict_id%5D=353&search%5Bfilter_enum_builttype%5D%5B0%5D=kamienica&search%5Bfilter_enum_rooms%5D%5B0%5D=one",
  ...
  .concat(
    [
      ...
      "okapy,_Bosch:Franke:Siemens,rodzaj!okap-wklad.bhtml",
      ...
      "projektory-multimedialne,rozdzielczosc-podstawowa!uhd-3840-x-2160.bhtml",
      ...
      "spieniacze-do-mleka,zasilanie!sieciowe,pojemnosc-do-spieniania_1!od-210-ml.bhtml",
      ...
      "telewizory-led-lcd-plazmowe,_Sony:Panasonic.bhtml",
  ...
  .concat(
    [
      "akcesoria/szczotki/murska-finska-skrobaczka-mosiezna-585-oryginal,p1988193168",
      "akcesoria/uszczelki/elring-korek-spustowy-567640,p782501600",
      "chemia/smary/wurth/wurth-spray-do-zamkow-bebenkowych-50ml,p2100819700",
      "filtry/filtry-kabinowe/weglowe/mann/mann-cuk-31-003-filtr-kabinowy-z-weglem,p854272327",
      "filtry/filtry-kabinowe/zwykle/mann/mann-cu-31-003-filtr-kabinowy,p1466937866",
      ...
      "plyny/plyny-do-spryskiwaczy/letnie/wurth/wurth-plyn-koncentrat-do-spryskiwaczy-szyb",
  ...
  .concat(
    [
      "bagazniki-i-uchwyty/bagazniki-sportowe/bagazniki-do-nart-i-desek-snowboardowych?search%5BproductBrandField%5D%5B%5D=6721",
      ...
      "bagazniki-rowerowe/akcesoria-do-bagaznikow-rowerowych?search[title]=epos",
      "bagazniki-rowerowe/bagazniki-rowerowe-na-dach?search%5BproductBrandField%5D%5B%5D=6721",
      "bagazniki-rowerowe/bagazniki-rowerowe-na-hak?search%5BproductBrandField%5D%5B%5D=6721",
      "boxy-i-kosze/akcesoria-do-boxow-i-koszy-bagazowych?search[title]=Multilift",
      "boxy-i-kosze/akcesoria-do-boxow-i-koszy-bagazowych?search%5BproductBrandField%5D%5B%5D=6721",
      "boxy-i-kosze/boxy-dachowe?search%5BproductBrandField%5D%5B%5D=6721",
  ...
  .concat(
    [
      ...
      "UACC-CABLE-C6A-CMP",
      "UACC-CABLE-C6A-CMR",
      "UACC-KEYSTONE-BLANK-INSERT",
      "UACC-RACK-12U-WALL",
      "UACC-RACK-12U-WALL-450-P",
      "UACC-RACK-12U-WALL-450-G",
      "UACC-RACK-12U-WALL-SLIM",
      "UACC-RACK-42U",
      ...
      "USW-PRO-MAX-48-POE",
      "UVC-G4_DOORBELL_PRO",
      "UVC-G4_DOORBELL_PRO_POE_KIT-WHITE",
      "UVC-G6-BULLET-W",
      "UVC-G6-TURRET-W",
    ]
      .map((path) => `https://www.senetic.pl/product/${path}`)
      .map((url, i) => ({
        data: {
          url,
        },
