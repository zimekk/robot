...
const SelectedRegion = z.object({
  ...
  stats: z.object({
    ...
    properties_all_rooms_ranges: z.object({
      1: z.number(),
      2: z.number(),
      3: z.number(),
      4: z.number(),
    ...
    properties_commercials_rooms_ranges: z.object({
      1: z.number(),
      2: z.number(),
      3: z.number(),
    }),
    ...
    properties_flats_rooms_ranges: z.object({
      1: z.number(),
      2: z.number(),
      3: z.number(),
      4: z.number(),
    ...
    properties_houses_rooms_ranges: z.object({
      3: z.number(),
      4: z.number(),
      5: z.number(),
      6: z.number(),
